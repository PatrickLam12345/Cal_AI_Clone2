// server/tools/seed_today_meals.js
...
const sampleMeals = [
  {
    ...
    source: 'scan',
    image_url: 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=400&h=400&fit=crop',
    ingredients: [
      {
  ...
  },
  {
    ...
    source: 'scan',
    image_url: 'https://images.unsplash.com/photo-1541519227354-08fa5d50c44d?w=400&h=400&fit=crop',
    ingredients: [
      {
  ...
  },
  {
    ...
    source: 'scan',
    image_url: 'https://images.unsplash.com/photo-1553530979-67eb72a56c8b?w=400&h=400&fit=crop',
    ingredients: [
      {
        name: 'Protein Powder',
        portion_desc: '30 g',
...
async function seedTodayMeals(uid) {
  console.log(`🍽️ Seeding today's meals for user: ${uid}`);
  ...
  for (const meal of sampleMeals) {
    ...
    mealCount++;
    console.log(`🍽️ Queued: ${meal.name} (${meal.kcal} kcal)`);
  }
  ...
  console.log(`📸 All meals have sample images!`);
}
...
async function main() {
  ...
  try {
    console.log('🚀 Starting today\'s meal seeding...\n');
